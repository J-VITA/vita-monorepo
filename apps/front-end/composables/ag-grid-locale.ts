...
export const AG_GRID_LOCALE_KO: AgGridLocale = {
	// Set Filter
	selectAll: "(전체 선택)",
	...
	advancedFilterValidationMessage: "표현식에 오류가 있습니다. ${variable} - ${variable}.",
	...
	ariaDropZoneColumnValueItemDescription: "집계 유형을 변경하려면 ENTER 키를 누르세요",
	...
	ariaLabelAdvancedFilterBuilderColumnSelectField: "고급 필터 생성기 열 선택 필드",
	ariaLabelAdvancedFilterBuilderOptionSelectField: "고급 필터 생성기 옵션 선택 필드",
	ariaLabelAdvancedFilterBuilderJoinSelectField: "고급 필터 생성기 조인 연산자 선택 필드",
