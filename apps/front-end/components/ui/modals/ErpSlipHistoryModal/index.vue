...
const {
	data: erpSlipList,
	status: erpSlipListStatus,
	refresh: erpSlipListRefresh,
} = await useAsyncData(
	`modal-slip-erp-slip-list`,
	async () =>
...
<template>
	...
	>
		...
		<a-table
			size="small"
			:loading="erpSlipListStatus === 'pending'"
			:columns="columns"
			:show-sorter-tooltip="false"
			:data-source="erpSlipList.data"
			...
			:pagination="
				Object.assign({}, pagination, {
					...
					pageSize: erpSlipList?.size,
					total: erpSlipList?.totalElements,
				})
			"
			@change="cellChange"
