...
import {
	useCompletedListColumns,
	useCompletedListSearch,
} from "@/types/approvals/completed"
...
const { searchParams, updateSearchParams } = useCompletedListSearch(
	getCompanyCode.value,
	getEmployeeId.value
)
const columns = useCompletedListColumns()
