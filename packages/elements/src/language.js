...
export const [ZH_CHS, EN, JA, AR, ES, DE, RO, RU, FR, PT_BR, PL, NL, ZH_CHT, TR, KO_KR] =
	[
		"zh-chs",
		"en",
		"ja",
...
export const languages = {
	...
	[KO_KR]: {
		...
		first: "처음",
		last: "마지막",
		// pageInfo: `페이지 ${LANG_PAGE_NUMBER}/${LANG_PAGE_COUNT} (총 ${LANG_ROW_COUNT}개 항목)`,
		pageInfo: `${LANG_PAGE_NUMBER}-${LANG_PAGE_COUNT} 항목 (전체 ${LANG_ROW_COUNT})`,
		notFound: "검색 결과 없음",
		clear: "내용 지우기",
		clearAll: "선택 항목 모두 지우기",
		maxSelected: `최대 ${LANG_MAX_SELECTED_LIMIT}개까지 선택 가능합니다`,
		placeholder: "항목을 선택하세요",
		selectedCount: `${LANG_SELECTED_COUNT}개 항목 선택됨`,
		search: "검색",
	},
}
